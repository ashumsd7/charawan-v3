...
const p = new URL("../src/app/manage-notifications/page.tsx", import.meta.url);
...
const neu = `  const validateEditNotification = (): boolean => {
    ...
    if (!cleanTitle || !cleanShort) {
      pushToast({ type: "error", title: "फ़ॉर्म अधूरा", body: "शीर्षक और छोट�िए।" });
      return false;
    }
    return true;
  };
...
console.log("patched notifications saveEdit");
